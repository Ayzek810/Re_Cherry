...
Re_Cherry AI Core 是一个基于 Vercel AI SDK 的统一 AI Provider 接口包，为 AI 应用提供强大的抽象层和插件化架构。
...
更强大的是，你还可以将自定义注册表与 Re_Cherry 的插件系统结合使用：
...
- [Re_Cherry 项目](https://github.com/CherryHQ/cherry-studio)
...
**Re_Cherry AI Core** - 让 AI 开发更简单、更强大、更灵活 🚀
