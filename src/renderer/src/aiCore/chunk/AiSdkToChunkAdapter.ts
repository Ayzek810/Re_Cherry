/**
 * AI SDK 到 Re_Cherry Chunk 适配器
 * 用于将 AI SDK 的 fullStream 转换为 Re_Cherry 的 chunk 格式
 */
...
/**
 * AI SDK 到 Re_Cherry Chunk 适配器类
 * 处理 fullStream 到 Re_Cherry chunk 的转换
 */
export class AiSdkToChunkAdapter {
  ...
  /**
   * 读取 fullStream 并转换为 Re_Cherry chunks
  ...
  /**
   * 转换 AI SDK chunk 为 Re_Cherry chunk 并调用回调
