...
// WebSearch subsystem was removed in batch 5; these types are kept as local
// stubs so the legacy tool-title renderer stays compilable.
type WebSearchToolInput = { additionalContext?: string } & Record<string, unknown>
type WebSearchToolOutput = { results?: Array<{ results?: unknown[] }> } & Record<string, unknown>
