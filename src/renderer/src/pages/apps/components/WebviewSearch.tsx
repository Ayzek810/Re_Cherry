...
const WebviewSearch: FC<WebviewSearchProps> = ({ webviewRef, isWebviewReady, appId }) => {
  ...
  return (
    <SearchPanel>
      ...
      />
      <MatchLabel title={noResultTitle} role="status" aria-live="polite" aria-atomic="true">
        {matchLabel}
      </MatchLabel>
      <Divider />
      <Button
...
// fork 缝：V2/V1 用 tailwind 类（border-default-200 等），fork 主题无这些令牌，改用 styled-components 等价实现
