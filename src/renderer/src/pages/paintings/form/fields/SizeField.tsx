...
// 原语 antd 化：V2 @cherrystudio/ui Input/RowFlex → antd Input + 普通 flex div。
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <Input
          aria-label={t('paintings.custom_width')}
          placeholder={t('paintings.custom_width')}
          type="number"
        ...
        <Input
          aria-label={t('paintings.custom_height')}
          placeholder={t('paintings.custom_height')}
          type="number"
