...
7.  **Promote Usage**: Promote Re_Cherry through blogs, social media, and other channels to attract more users and developers.
...
Automated tests are triggered on pull requests (PRs) opened by members of the Re_Cherry organization, except for draft PRs. PRs opened by new contributors will initially be marked with the `needs-ok-to-test` label and will not be automatically tested. Once a Re_Cherry organization member adds `/ok-to-test` to the PR, the test pipeline will be created.
...
v2 is the next major milestone for Re_Cherry, and we invite every developer to actively participate! Whether it's new feature development, architecture optimization, or code refactoring, your contributions on the `v2` branch are welcome. Let's build a better Re_Cherry together!
...
Thank you for your support and contributions! We look forward to working with you to make Re_Cherry a better product.
